...
router.post('/', async (req, res, next) => {
    try {
      ...
      const results = await db.query('INSERT INTO invoices (comp_code, amt) VALUES ($1, $2) RETURNING id, comp_code, amt, paid, add_date, paid_date', [comp_code, amt]);//USE A RETURNING CLAUSE- WE WON'T GET ANY INFORMATION BACK WITH POST REQUEST
      // console.log(results)
